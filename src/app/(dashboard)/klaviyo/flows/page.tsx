...
export default async function KlaviyoFlowDrilldownPage({
  ...
  return (
    <div className="space-y-6 pb-10">
      ...
      <section className="px-4 lg:px-6">
        <KlaviyoDrilldownControls action="/klaviyo/flows" filters={filters} tableFilters={tableFilters} />
      </section>
      ...
      <section className="px-4 lg:px-6">
        <DataTable
          ...
          description="Full automation-level rows with sortable URL controls above the table."
